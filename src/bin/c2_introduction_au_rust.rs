...
fn main() {
    ...
    l.add_log(log_entry::create_log_from_text(LogType::Info, "Mon convertisseur"));
    ...
    l.add_log(log_entry::create_log_string(LogType::Success, format!("{} cm", lg_en_pouces * 2.54)));
